...
#' @name example_mutations
#' @docType data
#' @aliases example_mutations
#' @title Single Nucleotide Variants and Patient Features in Lung Cancer Patients
#' @usage example_mutations
#' @keywords datasets
#'
#' @return A dataframe containing the chromosome number, base pair location, sample ID, gene name, patient features including:
#' age, sex, adjuvant therapy treatment, smoking history, tumor volume, ki67 quantification, and risk-classification for 
#' cancer progression.
#'
...
#'  \item{ADJUVANT_TX}{Statement of whether or not patient recieved adjuvant therapy}
...
#' }
#'
#' @description A dataframe containing the chromosome number, base pair location, sample ID, gene name, 
#' patient features including: age, sex, adjuvant therapy treatment, smoking history, tumor volume, 
#' ki67 quantification, and risk-classification for cancer progression. Data curated from cBioPortal dataset:
#' Non-Small Cell Lung Cancer (TRACERx, NEJM & Nature 2017)
#'
#' @references
#' Abbosh C et al.; 
#' TRACERx consortium; PEACE consortium; 
#' Swanton C. Phylogenetic ctDNA analysis depicts early-stage lung cancer evolution. 
#' Nature. 2017 Apr 26;545(7655):446-451. doi: 10.1038/nature22364. Erratum in: Nature. 2017 Dec 20;: 
